...
class SideBar(models.Model):
    ...
    title = models.CharField(max_length=50, verbose_name="标题")
    display_type = models.PositiveIntegerField(default=1, choices=SIED_TYPE, verbose_name='展示类型')
    content = models.CharField(max_length=50, blank=True, verbose_name='内容', help_text='如果设置的部署html, 可为空')
    owner = models.ForeignKey(User, verbose_name='作者', on_delete=models.DO_NOTHING)
